eff_summary <- function(eff.structure, eff.Sigma, eff.sd_trans, n.sim = 300000,
  ...
  #' @param plot.flag Whether output the plots or not. Default is F.
  #' @param plot.title Whether display the title of the plot or not. Default is T
  #'
  #' @details
...
eff_suggest <- function(eff.M, eff.sd, eff.sd_trans, n.sim = 30000){
  #' Suggest the input \code{eff.structure} of function \code{SimPRMD}
  #'
  #' Suggest the input \code{eff.structure} with selected \code{eff.sd_tran}
  #' of function SimPRMD for given efficacy mean matrix and efficacy standard
  #' deviation
  #'
  #' @param eff.M    The efficacy mean matrix whose (i,j)th element save the
  #' target mean of the efficacy data
  #' @param eff.sd   The target standard deviation of efficacy data
  #' @param eff.sd_trans The eff.sd_trans for test
  #' @param n.sim    The number of simulations for the numerical calculation in
  #' the function. The default is 30,000
  #'
  #' @return
  #' \item{eff.suggest}{The matrix suggested for the input \code{eff.structure} of
  #' function \code{SimPRMD}}
  #'
  ...
  #' # generate the desirable senerio
  #' eff.Sigma <- diag(6)
